  ...
  return (
    ...
    >
      ...
      <div className="relative h-full flex flex-col rounded-xl bg-slate-900/90 border border-slate-700/50 p-8 backdrop-blur-sm z-10">
        <div className="w-fit rounded-lg border border-indigo-500/30 bg-indigo-950/30 p-4 transition-all duration-300 group-hover:bg-indigo-900/40 group-hover:border-indigo-400/50">
          <div className="text-2xl">{icon}</div>
        </div>
        
        <div className="mt-6 flex-grow space-y-4">
          <h3 className="text-2xl md:text-3xl font-semibold text-indigo-100 tracking-tight transition-all duration-300 group-hover:text-white">
            {title}
          </h3>
          <div className="text-base md:text-lg text-slate-300 leading-relaxed transition-all duration-300 group-hover:text-slate-200">
            {description}
          </div>
        </div>
      </div>
