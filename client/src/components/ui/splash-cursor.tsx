...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    let colorProgram = new Program(baseVertexShader, copyShader);
    ...
    let gradientSubtractProgram = new Program(
      baseVertexShader,
    ...
    const position = gl.getAttribLocation(displayMaterial.activeProgram, "aPosition");
    ...
    function updatePointerMoveData(pointer, posX, posY, color) {
      if (pointer.down) {
        pointer.color = color || [0.3, 0.2, 0];
      }
      pointer.moved = pointer.down;
      pointer.dx = (posX - pointer.texcoordX) * config.SPLAT_FORCE;
      pointer.dy = (posY - pointer.texcoordY) * config.SPLAT_FORCE;
